...
char auth[] = "7093DZ"; // Blynk Auth Token
//
...
unsigned long ch_no = 1465640;//Replace with Thingspeak Channel no.
/****** MQTT Settings ********************************************************/
...
#define ELEVATION (91)             //Enter your elevation in m ASL to calculate rel pressure (ASL/QNH) at your place
